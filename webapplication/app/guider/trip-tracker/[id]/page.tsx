      ...
      <div className="flex h-screen w-full bg-gray-50">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-[480px] bg-white border-r border-gray-200 flex flex-col overflow-hidden shadow-sm">
            ...
            {/* Traveler Info */}
            <div className="p-5 border-b border-gray-200 bg-gray-50">
              <p className="text-xs text-gray-500 uppercase tracking-wider mb-2">Traveler</p>
              <div className="space-y-2">
                <p className="font-semibold text-sm">{trip.traveler.name}</p>
                <p className="text-xs text-gray-600">From {trip.traveler.country}</p>
                <div className="flex items-center gap-2">
                  <Users className="h-3 w-3 text-gray-400" />
                  <span className="text-xs text-gray-600">{trip.numberOfPeople} {trip.numberOfPeople === 1 ? "person" : "people"}</span>
                </div>
